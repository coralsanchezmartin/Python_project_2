...
def main():
    ...
    create_csv(CSV_FILE_REPLACE, list_replace, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    ...
    list_out_positives, count_out_positive = outliers_positives(csv_new_list, UPPER, COLUMN_NUMBER)
    print('Count in outlier positives csv : ', count_out_positive)
    list_out_negatives, count_out_negative = outliers_negatives(csv_new_list, LOWER, COLUMN_NUMBER)
    ...
    create_csv(CSV_FILE_COLONS, list_colons, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_NULL, null_val, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_POSITIVES, list_positives, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_NEGATIVES, list_negatives, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_POSITIVES_OUTLIERS, list_out_positives, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_NEGATIVES_OUTLIERS, list_out_negatives, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
    create_csv(CSV_FILE_EMPTY_VALUES, list_empty_values, DELIMITER_COLON, COLUMN_NUMBER1, COLUMN_NUMBER2)
